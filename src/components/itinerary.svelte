...
<div class="text-center rounded-lg bg-color iti shadow-xl">
	<p class="text-center text-orange uppercase text-lg lg:max-w-xl tracking-widest " on:click={()=>{router.redirect(`/trip-plan?trip-name=${itinerary.trip_name}&id=${itinerary.id}`)}}>
		{itinerary.trip_name}
	</p>
